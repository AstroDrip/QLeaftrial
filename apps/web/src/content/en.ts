export const content = {
  ...
  admin: { loginTitle: "Admin sign in", email: "Email address", password: "Password", signIn: "Sign in", dashboard: "Admin dashboard", products: "Products", orders: "Orders", logout: "Log out", newPassword: "New development password", stock: "Stock", price: "Price (QAR)" },
