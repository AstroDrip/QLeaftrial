export const content = {
  ...
  admin: { loginTitle: "Admin sign in", password: "Password", signIn: "Sign in", dashboard: "Admin dashboard", products: "Products", orders: "Orders", logout: "Log out", stock: "Stock", price: "Price (QAR)" },
