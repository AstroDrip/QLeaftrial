...
export interface CreateAdminProductInput { name: string; slug: string; sku: string; description: string; category: string; light: string; priceQar: number; costPrice: number; stock: number; imageDataUrl: string; imageAltText: string }
