...
const products = [
  {
    ...
    descriptionAr: "نبات وارف بأوراق لامعة يناسب مساحات المعيشة المضيئة.",
    category: "Indoor",
  ...
  },
  {
    ...
    descriptionAr: "أوراق نحتية تمنح المكان حضورًا رأسيًا هادئًا.",
    category: "Indoor",
    categoryAr: "نباتات داخلية",
    light: "Bright indirect",
    lightAr: "إضاءة ساطعة غير مباشرة",
  ...
  },
  {
    ...
    descriptionAr: "نبات قوي ومستقيم للزوايا التي لا تحتاج إلى عناية كثيرة.",
    category: "Indoor",
    categoryAr: "نباتات داخلية",
    light: "Low to bright indirect",
    lightAr: "إضاءة منخفضة إلى ساطعة غير مباشرة",
    priceQar: 120,
    costPrice: 55,
    quantity: 16,
  ...
  },
  {
    ...
    descriptionAr: "أوراق استوائية مشقوقة تمنح المساحة الداخلية مظهرًا غنيًا.",
    category: "Indoor",
    categoryAr: "نباتات داخلية",
  ...
  },
  {
    ...
    descriptionAr: "نبات عصاري محب للشمس بأوراق هندسية ومفيدة.",
    category: "Succulent",
    categoryAr: "نباتات عصارية",
    light: "Direct sun",
    lightAr: "شمس مباشرة",
    priceQar: 75,
    costPrice: 30,
  ...
  },
  {
    ...
    descriptionAr: "أزهار بيضاء ناعمة وأوراق عميقة للغرف الهادئة.",
    category: "Indoor",
    categoryAr: "نباتات داخلية",
    light: "Low to medium indirect",
    lightAr: "إضاءة منخفضة إلى متوسطة غير مباشرة",
    priceQar: 145,
    costPrice: 65,
    quantity: 14,
